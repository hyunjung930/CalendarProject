...
public class SendEmailAlarmJobConfiguration {
    ...
    public Step sendScheduleAlarmStep(
        ...
        return stepBuilderFactory.get("sendScheduleAlarm")
    ...
    public Step sendEngagementAlarmStep(
        ...
        return stepBuilderFactory.get("sendEngagementAlarm")
                .<SendMailBatchReq, SendMailBatchReq>chunk(CHUNK_SIZE)
    ...
    @Bean
    public ItemWriter<SendMailBatchReq> sendMailAlarmWriter(){
        return list -> {
